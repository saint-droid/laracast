...
<body style="font-family: Open Sans, sans-serif">
        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    <form id="logout-form" action="/logout" method="post" class="text-xs font-bold text-blue-500 ml-6" class="hidden">
                    @csrf
    ...
    @if(session()->has('success'))
        ...
        x-show="show"
         class="fixed bg-blue-500 text-white text-md py-6 px-8 rounded-xl bottom-3 right-3 ">
            <p > {{session('success')}}</p>
        </div>
    @endif
</body>
